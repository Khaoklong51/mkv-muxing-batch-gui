...
def get_light_palette():
    ...
    palette.setColor(
        QPalette.AlternateBase, QColor(*ColorThems.Light_AlternateBase_Color)
    )
    ...
    palette.setColor(
        QPalette.ColorRole.Highlight, QColor(*ColorThems.Light_Highlight_Color)
    )
    palette.setColor(
        QPalette.ColorRole.HighlightedText,
        QColor(*ColorThems.Light_HighlightedText_Color),
    )
    palette.setColor(
        QPalette.PlaceholderText, QColor(*ColorThems.Light_PlaceholderText_Color)
    )
    palette.setColor(
        QPalette.Active, QPalette.Button, QColor(*ColorThems.Light_Button_Color)
    )
    palette.setColor(
        QPalette.Disabled,
        QPalette.ButtonText,
        QColor(*ColorThems.Light_ButtonText_Color_Disabled),
    )
    palette.setColor(
        QPalette.Disabled,
        QPalette.WindowText,
        QColor(*ColorThems.Light_WindowText_Color_Disabled),
    )
    palette.setColor(
        QPalette.Disabled, QPalette.Base, QColor(*ColorThems.Light_Base_Color_Disabled)
    )
    palette.setColor(
        QPalette.Disabled,
        QPalette.AlternateBase,
        QColor(*ColorThems.Light_AlternateBase_Color_Disabled),
    )
    palette.setColor(
        QPalette.Disabled, QPalette.Text, QColor(*ColorThems.Light_Text_Color_Disabled)
    )
    palette.setColor(
        QPalette.Disabled, QPalette.Light, QColor(*ColorThems.Light_Light_Color_Disabled)
    )
    palette.setColor(
        QPalette.Disabled,
...
def get_dark_palette():
    ...
    palette.setColor(
        QPalette.ColorRole.Highlight, QColor(*ColorThems.Dark_Highlight_Color)
    )
    palette.setColor(
        QPalette.ColorRole.HighlightedText, QColor(*ColorThems.Dark_HighlightText_Color)
    )
    palette.setColor(
        QPalette.PlaceholderText, QColor(*ColorThems.Dark_PlaceholderText_Color)
    )
    palette.setColor(
        QPalette.Active, QPalette.Button, QColor(*ColorThems.Dark_Button_Color)
    )
    palette.setColor(
        QPalette.Disabled, QPalette.Button, QColor(*ColorThems.Dark_Button_Color_Disabled)
    )
    palette.setColor(
        QPalette.Disabled,
        QPalette.ButtonText,
        QColor(*ColorThems.Dark_ButtonText_Color_Disabled),
    )
    palette.setColor(
        QPalette.Disabled,
        QPalette.WindowText,
        QColor(*ColorThems.Dark_WindowText_Color_Disabled),
    )
    palette.setColor(
        QPalette.Disabled, QPalette.Base, QColor(*ColorThems.Dark_Base_Color_Disabled)
    )
    palette.setColor(
        QPalette.Disabled,
        QPalette.AlternateBase,
        QColor(*ColorThems.Dark_AlternateBase_Color_Disabled),
    )
    palette.setColor(
        QPalette.Disabled, QPalette.Text, QColor(*ColorThems.Dark_Text_Color_Disabled)
    )
    palette.setColor(
        QPalette.Disabled, QPalette.Light, QColor(*ColorThems.Dark_Light_Color_Disabled)
    )
    palette.setColor(
        QPalette.Disabled,
        QPalette.PlaceholderText,
