...
from packages.Tabs.SettingTab.Widgets.AudioLanguageOrderButton import (
    AudioLanguageOrderButton,
)
from packages.Tabs.SettingTab.Widgets.LanguagesComboBox import LanguagesComboBox
from packages.Tabs.SettingTab.Widgets.SubtitleLanguageOrderButton import (
    SubtitleLanguageOrderButton,
)
...
class DefaultLanguageLayout:
    def __init__(self, label_name, languages_list, default_language):
        ...
        self.languages_comboBox = LanguagesComboBox(
        ...
        if self.label.text().find("Subtitle") != -1:
            ...
            self.setting_button = AudioLanguageOrderButton(
                current_language_list=languages_list
            )
    ...
    def update_language_list(self, new_list):
        ...
        self.languages_comboBox.setCurrentIndex(
            self.current_languages_list.index(self.current_default_language)
        )
