...
class ChapterExtensionsCheckableComboBox(QComboBox):
    ...
    def __init__(self):
        ...
        # Use custom delegate
        self.setItemDelegate(ChapterExtensionsCheckableComboBox.Delegate())
    ...
    def make_default_extensions_checked(self):
        for i in range(self.model().rowCount()):
            if (
                ...
                in Options.CurrentPreset.Default_Chapter_Extensions
            ):
