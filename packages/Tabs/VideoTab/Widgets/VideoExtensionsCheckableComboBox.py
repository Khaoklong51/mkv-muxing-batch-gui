...
class VideoExtensionsCheckableComboBox(QComboBox):
    ...
    def __init__(self):
        ...
        self.set_current_extensions()
        self.is_there_old_files = False
        self.closeOnLineEditClick = False
        # Use custom delegate
        self.setItemDelegate(VideoExtensionsCheckableComboBox.Delegate())
    ...
    def set_current_extensions(self):
        self.current_extensions = Options.CurrentPreset.Default_Video_Extensions
    ...
    def make_default_extensions_checked(self):
        for i in range(self.model().rowCount()):
            if (
                ...
                in Options.CurrentPreset.Default_Video_Extensions
            ):
    ...
    def addItem(self, text, data=None):
        ...
        if data is None:
            ...
            item.setData(data)
        item.setFlags(Qt.ItemFlag.ItemIsEnabled or Qt.ItemFlag.ItemIsUserCheckable)
