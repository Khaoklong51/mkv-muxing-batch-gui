...
from packages.Tabs.AttachmentTab.Widgets.AllowDuplicateAttachmentsCheckBox import (
    AllowDuplicateAttachmentsCheckBox,
)
from packages.Tabs.AttachmentTab.Widgets.AttachmentClearButton import (
    AttachmentClearButton,
)
from packages.Tabs.AttachmentTab.Widgets.AttachmentSourceButton import (
...
class AttachmentSelectionSetting(GlobalSetting):
    ...
    def update_folder_path(self, new_path: str):
        if self.expert_mode_checkBox.isChecked():
            if new_path != "":
                ...
                self.attachment_refresh_files_button.update_current_path(
                    new_path=new_path
                )
    ...
    def setup_attachments_options_layout(self):
        ...
        self.attachments_options_layout.addWidget(
    ...
    def setup_main_layout(self):
        ...
        self.attachment_main_layout.addWidget(
            self.attachment_source_lineEdit, 0, 1, 1, 80
        )
        ...
        self.attachment_main_layout.addLayout(
            self.attachments_options_layout,
            1,
            39,
            1,
            -1,
    ...
    def connect_signals(self):
        ...
        self.attachment_refresh_files_button.clicked_signal.connect(
            self.update_folder_path
        )
        ...
        self.expert_mode_widget.is_there_old_paths_signal.connect(
    ...
    def set_default_directory(self):
        ...
        self.attachment_source_lineEdit.set_text_safe_change(
            Options.CurrentPreset.Default_Attachment_Directory
        )
