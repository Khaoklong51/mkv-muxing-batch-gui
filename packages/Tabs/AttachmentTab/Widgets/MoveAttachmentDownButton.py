...
class MoveAttachmentDownButton(QPushButton):
    swap_happened_signal = Signal()
    selected_row_after_swap = Signal(int)
    move_attachment_to_down_signal = Signal(int)
    ...
    def paintEvent(self, e):
        ...
        if Options.Dark_Mode and not self.dark_mode_applied:
            self.setIcon(GlobalIcons.DownDarkIcon)
