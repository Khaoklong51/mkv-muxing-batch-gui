...
class MoveAttachmentToButton(QPushButton):
    swap_happened_signal = Signal()
    selected_row_after_swap = Signal(int)
    move_attachment_to_position_signal = Signal(list)
    ...
    def clicked_button(self):
        ...
        if current_index != -1:
            ...
            if move_attachment_to_dialog.result == "Yes":
                ...
                self.move_attachment_to_position_signal.emit([current_index, new_index])
