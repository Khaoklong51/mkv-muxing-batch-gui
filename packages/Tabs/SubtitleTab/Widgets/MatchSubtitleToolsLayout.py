...
from packages.Tabs.SubtitleTab.Widgets.MoveSubtitleBottomButton import (
    MoveSubtitleBottomButton,
)
from packages.Tabs.SubtitleTab.Widgets.MoveSubtitleDownButton import (
    MoveSubtitleDownButton,
)
...
class MatchSubtitleToolsLayout(QVBoxLayout):
    ...
    def connect_signals(self):
        self.move_subtitle_up_button.swap_happened_signal.connect(
            self.refresh_subtitle_table
        )
        self.move_subtitle_up_button.selected_row_after_swap.connect(
            self.change_selected_subtitle_row
        )
        self.move_subtitle_top_button.swap_happened_signal.connect(
            self.refresh_subtitle_table
        )
        self.move_subtitle_top_button.selected_row_after_swap.connect(
            self.change_selected_subtitle_row
        )
        ...
        self.move_subtitle_down_button.swap_happened_signal.connect(
            self.refresh_subtitle_table
        )
        self.move_subtitle_down_button.selected_row_after_swap.connect(
            self.change_selected_subtitle_row
        )
        self.move_subtitle_bottom_button.swap_happened_signal.connect(
            self.refresh_subtitle_table
        )
        self.move_subtitle_bottom_button.selected_row_after_swap.connect(
            self.change_selected_subtitle_row
        )
        self.move_subtitle_to_button.swap_happened_signal.connect(
            self.refresh_subtitle_table
        )
        self.move_subtitle_to_button.selected_row_after_swap.connect(
            self.change_selected_subtitle_row
        )
        self.delete_subtitle_button.delete_happened_signal.connect(
            self.update_global_subtitle_files_list_order_deleting
        )
        self.delete_subtitle_button.selected_row_after_delete.connect(
            self.change_selected_subtitle_row
        )
    ...
    def setup_shortcuts(self):
        self.move_subtitle_up_shortcut = QShortcut(
            QKeySequence("Ctrl+Up"), self.subtitle_tab
        )
        self.move_subtitle_up_shortcut.activated.connect(
            self.move_subtitle_up_button.clicked_button
        )

        self.move_subtitle_down_shortcut = QShortcut(
            QKeySequence("Ctrl+Down"), self.subtitle_tab
        )
        self.move_subtitle_down_shortcut.activated.connect(
            self.move_subtitle_down_button.clicked_button
        )

        self.move_subtitle_top_shortcut = QShortcut(
            QKeySequence("Ctrl+PgUp"), self.subtitle_tab
        )
        self.move_subtitle_top_shortcut.activated.connect(
            self.move_subtitle_top_button.clicked_button
        )

        self.move_subtitle_bottom_shortcut = QShortcut(
            QKeySequence("Ctrl+PgDown"), self.subtitle_tab
        )
        self.move_subtitle_bottom_shortcut.activated.connect(
            self.move_subtitle_bottom_button.clicked_button
        )

        self.move_subtitle_to_shortcut = QShortcut(
            QKeySequence("Ctrl+M"), self.subtitle_tab
        )
        self.move_subtitle_to_shortcut.activated.connect(
            self.move_subtitle_to_button.clicked_button
        )

        self.delete_subtitle_shortcut = QShortcut(
            QKeySequence("Delete"), self.subtitle_tab
        )
        self.delete_subtitle_shortcut.activated.connect(
            self.delete_subtitle_button.clicked_button
        )
    ...
    def change_selected_subtitle_row(self, new_selected_index):
        new_selected_index = min(
            new_selected_index, len(GlobalSetting.SUBTITLE_FILES_LIST[self.tab_index]) - 1
        )
    ...
    def update_global_subtitle_files_list_order_to_top(self, index_to_move):
        while index_to_move > 0:
            temp_for_swap = GlobalSetting.SUBTITLE_FILES_LIST[self.tab_index][
                index_to_move
            ]
            ...
            temp_for_swap = GlobalSetting.SUBTITLE_FILES_ABSOLUTE_PATH_LIST[
                self.tab_index
            ][index_to_move]
    ...
    def update_global_subtitle_files_list_order_to_up(self, index_to_move):
        ...
        temp_for_swap = GlobalSetting.SUBTITLE_FILES_ABSOLUTE_PATH_LIST[self.tab_index][
            index_to_move
        ]
    ...
    def update_global_subtitle_files_list_order_to_position(
        self, list_of_old_and_new_index
    ):
    ...
    def update_global_subtitle_files_list_order_deleting(self, index_to_delete):
        ...
        del GlobalSetting.SUBTITLE_FILES_ABSOLUTE_PATH_LIST[self.tab_index][
            index_to_delete
        ]
        self.refresh_subtitle_table()
