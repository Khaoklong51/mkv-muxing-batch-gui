...
class MoveSubtitleUpButton(QPushButton):
    swap_happened_signal = Signal()
    selected_row_after_swap = Signal(int)
    move_subtitle_to_up_signal = Signal(int)
