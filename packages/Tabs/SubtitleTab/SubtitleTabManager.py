...
from packages.Tabs.SubtitleTab.Widgets.SubtitleTabDeleteButton import (
    SubtitleTabDeleteButton,
)
...
class SubtitleTabManager(GlobalSetting):
    ...
    def delete_current_tab(self):
        ...
        self.MainLayout.replaceWidget(
            self.subtitle_tabs[index_in_list], self.subtitle_tabs[previous_tab_index]
        )
    ...
    def set_preset_options(self):
        for subtitle_tab in self.subtitle_tabs:
            subtitle_tab.set_preset_options()
