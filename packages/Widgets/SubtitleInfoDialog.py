...
class SubtitleInfoDialog(MyDialog):
    def __init__(
        ...
        self.subtitle_editable_setting_layout.addRow(
            self.subtitle_name_label, self.subtitle_name_value
        )
        self.subtitle_editable_setting_layout.addRow(
        ...
        self.subtitle_editable_setting_layout.addRow(
            self.subtitle_set_default_label, self.subtitle_set_default_checkBox
        )
        self.subtitle_editable_setting_layout.addRow(
    ...
    def setup_subtitle_language_comboBox(self):
        self.subtitle_language_comboBox.addItems(
            Options.CurrentPreset.Default_Favorite_Subtitle_Languages
        )
    ...
    def update_current_subtitle_set_default(self):
        new_state = (
            self.subtitle_set_default_checkBox.checkState() == Qt.CheckState.Checked
        )
    ...
    def update_current_subtitle_set_forced(self):
        new_state = (
            self.subtitle_set_forced_checkBox.checkState() == Qt.CheckState.Checked
        )
    ...
    def reset_subtitle_setting(self):
        self.current_subtitle_language[self.current_subtitle_index] = (
            self.default_subtitle_language[self.current_subtitle_index]
        )
        self.current_subtitle_delay[self.current_subtitle_index] = (
            self.default_subtitle_delay[self.current_subtitle_index]
        )
        self.current_subtitle_track_name[self.current_subtitle_index] = (
            self.default_subtitle_track_name[self.current_subtitle_index]
        )
        self.current_subtitle_set_default[self.current_subtitle_index] = (
            self.default_subtitle_set_default[self.current_subtitle_index]
        )
        self.current_subtitle_set_forced[self.current_subtitle_index] = (
            self.default_subtitle_set_forced[self.current_subtitle_index]
        )
    ...
    def setup_tool_tip_hint_subtitle_set_default(self):
        if self.subtitle_set_default_checkBox.isEnabled():
            self.subtitle_set_default_checkBox.setToolTip(
                "<nobr>set this subtitle to be the default subtitle track " "when play"
            )
    ...
    def setup_tool_tip_hint_subtitle_set_forced(self):
        if self.subtitle_set_forced_checkBox.isEnabled():
            self.subtitle_set_forced_checkBox.setToolTip(
                "<nobr>set this subtitle to be the forced subtitle track when " "play"
            )
